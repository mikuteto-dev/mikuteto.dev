...
export function CopyButton({
  ...
  return (
    <m.button
      ...
      className={`inline-flex h-9 select-none items-center gap-2 rounded-[9px] border border-ink-700 bg-ink-850 px-3 text-[13px] font-medium text-ink-200 transition-[border-color,background-color] duration-150 hover:bg-ink-800 focus-visible:border-ink-300 disabled:opacity-50 ${className}`}
    >
