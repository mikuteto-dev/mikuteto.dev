...
export function StreamingText({
  ...
  const caret = (
    ...
    >
      <m.span
        className="absolute inset-y-0 left-px block w-[2px] bg-ink-100"
        initial={false}
  ...
  return (
    <div
      ...
      className={`text-[13.5px] leading-relaxed text-ink-200 ${className}`}
    >
      ...
      {showSkip ? (
        <div className="mt-2.5 flex justify-end">
          <button
            ...
            className="inline-grid h-7 place-items-center rounded-[6px] border border-ink-700 px-2.5 text-[11.5px] font-medium text-ink-400 transition-colors duration-150 hover:text-ink-100 focus-visible:ring-2 focus-visible:ring-ink-400 focus-visible:outline-none"
          >
            <m.span
              aria-hidden
